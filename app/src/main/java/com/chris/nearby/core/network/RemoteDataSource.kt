package com.chris.nearby.core.network

import com.chris.nearby.core.network.KtorHttpClient.httpClientAndroid
import com.chris.nearby.data.model.Category
import com.chris.nearby.data.model.Coupon
import com.chris.nearby.data.model.Market
import com.chris.nearby.data.model.MarketDetails
...
object NearbyRemoteDataSource {
    ...
    // private const val BASE_URL = LOCAL_HOST_PHYSICAL_BASE_URL << Para Rodar com o dispositivo físico
